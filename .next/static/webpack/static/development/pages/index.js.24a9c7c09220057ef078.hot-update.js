...
})(["background:var(--bg-gradient);padding:4em 1em;.content--container{display:grid;grid-template-columns:repeat(2,1fr);grid-auto-rows:auto;justify-items:center;}.btn--container{position:relative;display:flex;justify-content:center;width:100%;&::before,&::after{position:absolute;content:'';top:50%;left:0;height:1px;background-color:rgba(255,255,255,0.6);}&::before{position:absolute;content:'';top:50%;left:0;right:0;width:100%;height:1px;background-color:rgba(255,255,255,0.6);}}.card--title{grid-column:1 / 3;justify-self:center;margin-bottom:3em;}.title{text-transform:capitalize;font-weight:bold;}.subtitle{color:var(--grey-clr);}@media screen and (min-width:768px){.content--container{display:grid;grid-template-columns:repeat(4,1fr);grid-auto-rows:auto;justify-items:center;}.card--title{grid-column:1 / 5;}}@media screen and (min-width:1000px){.content--container{grid-template-columns:repeat(auto-fit,minmax(200px,1fr));}.card--title{grid-column:1 / 3;}}"]);
...
//# sourceMappingURL=index.js.24a9c7c09220057ef078.hot-update.js.map
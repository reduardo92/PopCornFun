...
})([".title{font-size:1.1rem;}.card--body__overview,.more--info,.poster__img{display:none;}.card--body{&__head{display:flex;align-items:center;}}@media screen and (min-width:768px){.card--body__overview,.more--info{display:block;}}@media screen and (min-width:1000px){.backdrop__img{display:none;}.poster__img{display:block;}}"]);
...
//# sourceMappingURL=movie.js.e73293fc5eaf3451d440.hot-update.js.map
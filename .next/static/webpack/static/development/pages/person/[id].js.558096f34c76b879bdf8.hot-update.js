...
})(["background:var(--white-clr);margin-top:110px;.profile--person{max-width:300px;margin:0 auto;}@media screen and (min-width:1000px){margin-top:70px;display:grid;grid-template-areas:'pp bio' 'pf pm';grid-template-columns:2fr 1fr;.profile--person{grid-area:pp;justify-self:end;max-width:355px;margin:0;z-index:10;}.profile--biography{grid-area:bio;align-self:center;justify-self:center;color:black;}.profile--media{grid-area:pm;background:var(--bg-dark-gradient);}.profile--media--container{}.profile--facts{grid-area:pf;}}"]);
...
//# sourceMappingURL=[id].js.558096f34c76b879bdf8.hot-update.js.map
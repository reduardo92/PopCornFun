...
var PersonProfile = function PersonProfile(_ref) {
  ...
  var splitBio = function splitBio(text) {
    var textLength = text.length;
    var firstPara = 1064;
    var subtRest = textLength - firstPara;
    var numPara = subtRest / 4;
    var splitText = text.split(' ').map(function (item, i) {
      return i > 10 && item;
    });
    return "".concat(textLength, " ").concat(firstPara, " ").concat(numPara, " ").concat(splitText);
  };

  console.log('bio', splitBio(person.biography));
...
//# sourceMappingURL=[id].js.6b0d3feca6a6c4879075.hot-update.js.map
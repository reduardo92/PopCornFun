...
})(["background:var(--bg-dark-gradient);margin-top:110px;.profile--person{max-width:300px;margin:0 auto;}@media screen and (min-width:1000px){margin-top:70px;display:grid;grid-template-areas:'pp bio bio' 'pf pm pm';grid-template-columns:1.5fr 1fr 1fr;.profile--person{grid-area:pp;justify-self:end;max-width:355px;margin:0;z-index:10;}.profile--biography{grid-area:bio;align-self:center;justify-self:center;}.profile--media{grid-area:pm;background-color:red;}.profile--media--container{max-width:1100px;}.profile--facts{grid-area:pf;}}"]);
...
//# sourceMappingURL=[id].js.aab71d994e06962741f4.hot-update.js.map
...
})(["background:var(--bg-gradient);margin-top:110px;padding:2em 1em;.profile--person{max-width:300px;margin:0 auto;}.profile--biography{margin:2em 0;&__name{font-weight:bold;margin-bottom:1em;text-align:center;}}.knonwFor--content{.card--one{width:180px;margin:0 1em;}}@media screen and (min-width:768px){}"]);
...
var PersonProfile = function PersonProfile(_ref) {
  ...
  return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_15__["default"], {
    ...
    return __jsx(_components_ui_Cards_CardOne__WEBPACK_IMPORTED_MODULE_21__["default"], {
      key: item.id,
      data: item,
...
//# sourceMappingURL=[id].js.616177b525f61b9ac2ed.hot-update.js.map
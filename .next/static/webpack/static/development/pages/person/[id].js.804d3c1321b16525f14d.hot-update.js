    ...
    return entr.map(function (_ref6, index) {
      ...
      return __jsx("div", {
        ...
        return __jsx("p", {
          ...
          __self: this
        }, iss[0].date), " ", iss[0].title);
      }));
    });
  };

  console.log('hello', _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_9___default()(Object(_components_utility_groupeCrew__WEBPACK_IMPORTED_MODULE_20__["default"])(person.movie_credits.crew, 'department', 'release_date')));
...
//# sourceMappingURL=[id].js.804d3c1321b16525f14d.hot-update.js.map
...
var MediaCredits = function MediaCredits(_ref) {
  ...
  return __jsx(Styled, {
    ...
    __self: this
  }, "Acting"), data.movie_credits.cast && tab === 'movies' ? actingDiv(data.movie_credits.cast, 'release_date', 'movie') : data.tv_credits.cast && tab === 'tv' ? actingDiv(data.tv_credits.cast, 'first_air_date', 'tv') : __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 101
    },
...
//# sourceMappingURL=[id].js.33de5c1668f7ccc4c8eb.hot-update.js.map
...
})(["display:grid;grid-template-columns:repeat(2,1fr);align-items:center;justify-content:center;.tabs--container{flex-wrap:nowrap;}&--content{display:grid;grid-column:1 / 3;margin-top:1.2em;grid-gap:1.5em;}.grouped{& > div:first-child{padding-top:0.6em !important;}& > div:last-child{padding-bottom:0.6em !important;}.date{flex:0 0 9%;}}"]);
...
var MediaCredits = function MediaCredits(_ref) {
  ...
  var actingDiv = function actingDiv(arry, media) {
    return _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_1___default()(arry).sort(function (a, b) {
      return b[0] - a[0];
    }).map(function (_ref2) {
  ...
  return __jsx(Styled, {
    ...
    __self: this
  }, "Acting"), tab === 'movies' ? actingDiv(groupByDate(data.movie_credits.cast, 'release_date'), 'movie') : actingDiv(groupByDate(data.tv_credits.cast, 'first_air_date'), 'tv')), tab === 'movies' ? crewDiv(data.movie_credits.crew, 'release_date', 'movie') : crewDiv(data.tv_credits.crew, 'first_air_date', 'tv')));
};
...
/* harmony import */ var _components_context_MovieContext__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../components/context/MovieContext */ "./components/context/MovieContext.js");
/* harmony import */ var _components_ui_SimpleFlex__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../components/ui/SimpleFlex */ "./components/ui/SimpleFlex.js");
/* harmony import */ var _components_ui_Cards_RecommenCard__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../components/ui/Cards/RecommenCard */ "./components/ui/Cards/RecommenCard.jsx");
/* harmony import */ var _components_utility_groupByDate__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../components/utility/groupByDate */ "./components/utility/groupByDate.js");
/* harmony import */ var _components_utility_groupeCrew__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../components/utility/groupeCrew */ "./components/utility/groupeCrew.js");
/* harmony import */ var _components_utility_numberWithCommas__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../components/utility/numberWithCommas */ "./components/utility/numberWithCommas.js");
/* harmony import */ var _components_ui_mediaProfile_CreditsTabs__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../components/ui/mediaProfile/CreditsTabs */ "./components/ui/mediaProfile/CreditsTabs.jsx");
/* harmony import */ var _components_ui_PersonProfile_KnownFor__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../components/ui/PersonProfile/KnownFor */ "./components/ui/PersonProfile/KnownFor.jsx");
/* harmony import */ var _components_ui_PersonProfile_MediaCredits__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../components/ui/PersonProfile/MediaCredits */ "./components/ui/PersonProfile/MediaCredits.jsx");
...
var PersonProfile = function PersonProfile(_ref) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])('movies'),
      tab = _useState[0],
      setTab = _useState[1];

  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_8__["useContext"])(_components_context_MovieContext__WEBPACK_IMPORTED_MODULE_14__["default"]),
  ...
  return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_12__["default"], {
    ...
    src: "".concat(_components_context_types__WEBPACK_IMPORTED_MODULE_9__["IMG_URL"]).concat(person.profile_path),
    alt: person.name,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 102
    ...
    __self: this
  }, __jsx(_components_ui_PersonProfile_KnownFor__WEBPACK_IMPORTED_MODULE_21__["default"], {
    data: knonwFor,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120
    ...
    __self: this
  }), __jsx(_components_ui_PersonProfile_MediaCredits__WEBPACK_IMPORTED_MODULE_22__["default"], {
    data: person,
    tab: tab,
    setTab: setTab,
    __source: {
...
//# sourceMappingURL=[id].js.3c18e7180e1c9e940c07.hot-update.js.map
...
var MediaCredits = function MediaCredits(_ref) {
  ...
  return __jsx(Styled, {
    ...
    __self: this
  }, "nothing avalebale")), tab === 'movies' ? crewDiv(data.movie_credits.crew, 'release_date', 'movie') : crewDiv(data.tv_credits.crew, 'first_air_date', 'tv')));
};
...
//# sourceMappingURL=[id].js.0deba545c3ef6927b42c.hot-update.js.map
...
var PersonProfile = function PersonProfile(_ref) {
  ...
  var creditsDiv = function creditsDiv(arry) {
    return _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_9___default()(arry).map(function (_ref2, index) {
      ...
      return __jsx("div", {
        key: index,
        className: "grouped border border-darken-3",
        __source: {
        ...
        return __jsx("div", {
          ...
          className: "d-flex shadow-sm border border-light bg-light",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 84
          },
...
//# sourceMappingURL=[id].js.eda77afd808320ab0503.hot-update.js.map
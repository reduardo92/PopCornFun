...
})(["@media screen and (min-width:1000px){.knonwFor--content{all:unset;display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));grid-gap:2.7em 1em;padding-top:1.2em;div{margin:0;}}}@media screen and (min-width:1000px){.subTitle{color:var(--second-clr);}.recommend--card{.recommend--card__content--name{}}}"]);
...
//# sourceMappingURL=[id].js.20ff28be137cf5831726.hot-update.js.map
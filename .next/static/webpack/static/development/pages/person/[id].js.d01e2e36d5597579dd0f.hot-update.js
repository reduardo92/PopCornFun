...
})(["background:var(--bg-dark-gradient);margin-top:110px;.profile--person{max-width:300px;margin:0 auto;}@media screen and (min-width:1000px){display:grid;grid-template-areas:'pp pp bio' 'pf pf pm';.profile--person{grid-area:pp;}.profile--biography{grid-area:bio;}.profile--media{grid-area:pm;}.profile--facts{grid-area:pf;}}"]);
...
//# sourceMappingURL=[id].js.d01e2e36d5597579dd0f.hot-update.js.map
...
var MediaCredits = function MediaCredits(_ref) {
  ...
  return __jsx(Styled, {
    ...
    __self: this
  }, "nothing available")), tab === 'movies' ? crewDiv(data.movie_credits.crew, 'release_date', 'movie') : crewDiv(data.tv_credits.crew, 'first_air_date', 'tv')));
};
...
//# sourceMappingURL=[id].js.8431f952b3267952da00.hot-update.js.map
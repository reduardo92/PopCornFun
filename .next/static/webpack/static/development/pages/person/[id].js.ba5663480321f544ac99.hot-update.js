...
})(["background:var(--bg-dark-gradient);margin-top:110px;.profile--person{max-width:300px;margin:0 auto;}@media screen and (min-width:1000px){display:grid;grid-template-areas:'pp pp pp bio' 'pf pf pf pm';grid-template-columns:repeat(5,1fr);.profile--person{grid-area:pp;}.profile--biography{grid-area:bio;}.profile--media{grid-area:pm;}.profile--facts{grid-area:pf;}}"]);
...
//# sourceMappingURL=[id].js.ba5663480321f544ac99.hot-update.js.map
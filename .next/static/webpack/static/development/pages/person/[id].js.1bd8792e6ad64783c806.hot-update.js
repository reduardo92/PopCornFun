    ...
    return _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_9___default()(arry).sort(function (a, b) {
      ...
      return __jsx("div", {
        ...
        return __jsx("div", {
          ...
          __self: this
        }, i.title || i.name), i.job ? i.job : i.character ? "as ".concat(i.character) : ''));
      }));
    });
  };
    ...
    return entr.map(function (_ref4, index) {
      ...
      return __jsx("div", {
        ...
        return item.map(function (i) {
          return __jsx(react__WEBPACK_IMPORTED_MODULE_10___default.a.Fragment, null, __jsx("span", {
            className: "date text-dark mr-4",
            __source: {
              fileName: _jsxFileName,
              lineNumber: 140
...
//# sourceMappingURL=[id].js.1bd8792e6ad64783c806.hot-update.js.map
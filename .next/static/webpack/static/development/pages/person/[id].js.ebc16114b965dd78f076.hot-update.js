...
})(["background:var(--bg-dark-gradient);margin-top:110px;.profile--person{max-width:300px;margin:0 auto;}@media screen and (min-width:1000px){margin-top:70px;display:grid;grid-template-areas:'pp bio .' 'pf pm .';grid-template-columns:600px 1fr 7em;.profile--person{grid-area:pp;justify-self:end;max-width:355px;margin-bottom:-5em;z-index:10;margin-right:1;}.profile--biography{grid-area:bio;align-self:center;justify-self:center;}.profile--media{grid-area:pm;max-width:1000px;justify-self:center;}.profile--facts{grid-area:pf;}}"]);
...
//# sourceMappingURL=[id].js.ebc16114b965dd78f076.hot-update.js.map
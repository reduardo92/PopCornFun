...
})(["background:var(--bg-dark-gradient);margin-top:110px;.profile--person{max-width:300px;margin:0 auto;img{height:100%;object-fit:contain;}}.line-between{display:none;height:50px;width:100%;background-color:var(--primary-clr);}@media screen and (min-width:1000px){margin-top:70px;display:grid;grid-template-areas:'pp bio' 'linn linn' 'pf pm';grid-template-columns:calc(100% - 60%) 1fr;grid-auto-rows:auto 50px auto;.profile--person{grid-area:pp;justify-self:end;max-width:355px;margin:0;z-index:10;}.profile--biography{grid-area:bio;align-self:center;justify-self:center;}.line-between{grid-area:lin;display:block;}.profile--media{grid-area:pm;padding-left:2em;padding-top:1.2em;}.profile--media--container{max-width:1200px;}.profile--facts{grid-area:pf;}}"]);
...
//# sourceMappingURL=[id].js.7c41be416f4bf2d82b4e.hot-update.js.map
...
})(["background:var(--bg-gradient);margin-top:110px;padding:2em 1em;.profile--person{max-width:300px;margin:0 auto;}.profile--biography{margin:2em 0;display:grid;&__name{font-weight:bold;margin-bottom:1em;text-align:center;}.read--more{display:block;justify-content:center;align-items:center;margin:0 auto;&__arrow{background-color:red;font-size:1.4rem;}}}@media screen and (min-width:768px){}"]);
...
//# sourceMappingURL=[id].js.9e862547083729dfb548.hot-update.js.map
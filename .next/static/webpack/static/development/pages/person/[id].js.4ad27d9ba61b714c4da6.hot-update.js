...
})([".card--one{flex:0 0 160px;margin-right:1.5em;}@media screen and (min-width:1000px){.knonwFor--content{all:unset;display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));grid-gap:1em;padding-top:1.2em;div{margin:0;}}}@media screen and (min-width:1000px){.subTitle{color:var(--second-clr);}.card--one{&__title a{color:var(--second-clr);}}}"]);
...
//# sourceMappingURL=[id].js.4ad27d9ba61b714c4da6.hot-update.js.map
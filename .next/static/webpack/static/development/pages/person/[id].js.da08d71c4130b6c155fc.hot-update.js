...
var MediaCredits = function MediaCredits(_ref) {
  ...
  return __jsx(Styled, {
    ...
    __self: this
  }, data.data.movie_credits.cast || data.tv_credits.cast && __jsx("h3", {
    className: "subTitle text-light my-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 94
    ...
    __self: this
  }, "Acting"), data.data.movie_credits.cast && tab === 'movies' ? actingDiv(data.movie_credits.cast, 'release_date', 'movie') : data.tv_credits.cast && tab === 'tv' ? actingDiv(data.tv_credits.cast, 'first_air_date', 'tv') : __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 101
    },
...
//# sourceMappingURL=[id].js.da08d71c4130b6c155fc.hot-update.js.map
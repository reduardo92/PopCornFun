...
var PersonProfile = function PersonProfile(_ref) {
  ...
  var splitBio = function splitBio(text) {
    ...
    var slicc = text.slice(0, firstPara);
    return "".concat(textLength, " ").concat(slicc, " ").concat(numPara, " ").concat(splitText);
  };
...
//# sourceMappingURL=[id].js.976040ad9fbe372add41.hot-update.js.map
...
})(["@media screen and (min-width:1000px){.knonwFor--content{all:unset;display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));grid-gap:2.7em 1em;padding-top:1.2em;div{margin:0;}}}@media screen and (min-width:1000px){.subTitle{color:var(--second-clr);}.recommend--card__content--name{color:var(--second-clr);}}"]);
...
//# sourceMappingURL=[id].js.29899dfd3024bfbd8845.hot-update.js.map
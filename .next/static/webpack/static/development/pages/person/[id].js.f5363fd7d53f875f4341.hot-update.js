...
})([".card--one{flex:0 0 160px;margin-right:1.5em;}"]);
...
var KnownFor = function KnownFor(_ref) {
  ...
  return __jsx(Styled, {
    ...
    return __jsx(_Cards_CardOne__WEBPACK_IMPORTED_MODULE_4__["default"], {
      key: Math.random() * 10,
      data: item,
...
/* harmony default export */ __webpack_exports__["default"] = (KnownFor); // @media screen and (min-width: 1000px) {
//   .knonwFor--content {
//     all: unset;
//     display: grid;
...
//# sourceMappingURL=[id].js.f5363fd7d53f875f4341.hot-update.js.map
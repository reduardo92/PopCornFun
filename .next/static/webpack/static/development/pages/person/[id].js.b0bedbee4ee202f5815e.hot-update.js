...
var PersonProfile = function PersonProfile(_ref) {
  ...
  }).slice(0, 8); // const arrData = arry.reduce((acc, obj) => {
  //   let key = obj.name;
  //   if (!acc[key]) {
  //     acc[key] = [];
  //   }
  ...
  console.log(person.movie_credits.cast.sort(function (a, b) {
...
//# sourceMappingURL=[id].js.b0bedbee4ee202f5815e.hot-update.js.map
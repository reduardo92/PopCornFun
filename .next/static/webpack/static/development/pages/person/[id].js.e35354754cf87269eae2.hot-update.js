...
})(["background:var(--bg-gradient);margin-top:110px;padding:2em 1em;.profile--person{max-width:300px;margin:0 auto;}.profile--biography{margin:2em 0;&__name{font-weight:bold;margin-bottom:1em;text-align:center;}.read--more{display:flex;justify-content:center;align-items:center;&__arrow{background-color:red;border-radius:50%;}}}@media screen and (min-width:768px){}"]);
...
//# sourceMappingURL=[id].js.e35354754cf87269eae2.hot-update.js.map
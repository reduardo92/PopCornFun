...
})(["background:var(--bg-gradient);margin-top:110px;padding:2em 1em;.profile--person{max-width:300px;margin:0 auto;}.profile--biography{margin:2em 0;display:grid;&__name{font-weight:bold;margin-bottom:1em;text-align:center;}.read--more{margin:0 auto;background-color:red;display:flex;align-items:center;&__arrow{font-size:1.4rem;}}}@media screen and (min-width:768px){}"]);
...
//# sourceMappingURL=[id].js.6e9486c9a94d422eb040.hot-update.js.map
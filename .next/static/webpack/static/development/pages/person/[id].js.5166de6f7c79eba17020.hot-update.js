...
var MediaCredits = function MediaCredits(_ref) {
  ...
  var actingDiv = function actingDiv(arry, sortBy, media) {
    ...
    _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_1___default()(data).sort(function (a, b) {
      return b[0] - a[0];
    }).map(function (_ref2) {
  ...
  return __jsx(Styled, {
    ...
    __self: this
  }, "Acting"), tab === 'movies' ? actingDiv(data.movie_credits.cast, 'release_date', 'movie') : actingDiv(data.tv_credits.cast, 'first_air_date', 'tv')), tab === 'movies' ? crewDiv(data.movie_credits.crew, 'release_date', 'movie') : crewDiv(data.tv_credits.crew, 'first_air_date', 'tv')));
};
...
//# sourceMappingURL=[id].js.5166de6f7c79eba17020.hot-update.js.map
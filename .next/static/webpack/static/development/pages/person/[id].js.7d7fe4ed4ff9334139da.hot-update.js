...
})(["background:var(--bg-dark-gradient);margin-top:110px;.profile--person{max-width:300px;margin:0 auto;}.line-between{display:block;height:50px;width:100%;background-color:var(--primary-clr);}@media screen and (min-width:1000px){margin-top:70px;display:grid;grid-template-areas:'pp bio' 'linne linne' 'pf pm';grid-template-columns:calc(100% - 60%) 1fr;.profile--person{grid-area:pp;justify-self:end;max-width:355px;margin:0;z-index:10;}.profile--biography{grid-area:bio;align-self:center;justify-self:center;}.line-between{grid-area:linee;display:blockl;}.profile--media{grid-area:pm;padding-left:2em;padding-top:1.2em;}.profile--media--container{max-width:1200px;}.profile--facts{grid-area:pf;}}"]);
...
//# sourceMappingURL=[id].js.7d7fe4ed4ff9334139da.hot-update.js.map
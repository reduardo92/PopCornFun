...
})(["position:relative;min-height:85vh;background:linear-gradient(rgba(0,0,0,0.55),rgba(0,0,0,0.55)),url(", ") no-repeat center;background-size:cover;object-fit:cover;width:100%;display:flex;align-items:center;justify-content:center;.max-width{padding:0 1em;}.fetured--content{width:100%;max-width:480px;}.heading{display:flex;width:100%;align-items:center;justify-content:center;}.title{margin-right:1em;}@media screen and (min-width:768px){min-height:50vh;}"], function (_ref) {
...
//# sourceMappingURL=index.js.8ea69a6ba93afc435b3c.hot-update.js.map
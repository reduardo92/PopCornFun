...
})(["@media screen and (min-width:768px){flex:100%;margin-bottom:1em;.discover--from{display:flex;justify-content:space-between;& > div{flex:1;margin-right:1em;}& >:last-child{margin-right:0;}}}.genre--control{}@media screen and (min-width:1000px){flex:1;margin-left:2em;.discover--from{display:flex;justify-content:space-between;& > div{flex:1;margin-right:1em;}& >:last-child{margin-right:0;}}}"]);

var DiscoverForm = function DiscoverForm() {
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_context_MovieContext__WEBPACK_IMPORTED_MODULE_7__["default"]),
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (year === '' && sort_by === 'popularity.desc' && genre === '') {
      ...
      push("/discover?query=".concat(query.query, "&page=").concat(query.page).concat(sortQuery).concat(yearQuery).concat(genreQuery));
    }
  }, [form]);
  console.log(form); //   console.log(discoverForm);
...
//# sourceMappingURL=discover.js.135a230e989de54e71d3.hot-update.js.map
...
})([".title{font-size:1.1rem;}.card--body__overview,.more--info,.poster__img{display:none;}@media screen and (min-width:768px){.card--body__overview,.more--info{display:block;}}@media screen and (min-width:1000px){.backdrop__img{display:none;}}"]);
...
//# sourceMappingURL=movie.js.6d8e6c9f210fa9f60e91.hot-update.js.map
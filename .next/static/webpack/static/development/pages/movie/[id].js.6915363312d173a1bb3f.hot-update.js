...
var MovieProfile = function MovieProfile(_ref2) {
  ...
  var fdf = movie.credits.crew.reduce(function (accumulator, currentValue) {
    return [accumulator].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(currentValue.department));
  }, []);
  console.log(fdf);
  return __jsx(Styled, {
    className: "profile",
...
//# sourceMappingURL=[id].js.6915363312d173a1bb3f.hot-update.js.map
...
var ProfileHeader = function ProfileHeader(_ref) {
  ...
  var timeConvert = function timeConvert(time) {
    var hours = Math.floor(time / 60); // const rhours = Math.floor(hours);

    var minutes = Math.round(hours * 60);
    var rminutes = Math.round(minutes);
    return "".concat(rhours, "h ").concat(rminutes, "m");
  };
...
//# sourceMappingURL=[id].js.2afd17a498c8b62eec5f.hot-update.js.map
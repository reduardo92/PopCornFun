...
})(["padding:1em 0.5em;max-width:1000px;.subTitle{margin-bottom:1.5em;}.simple--flex{& >:first-child{margin-left:0.5em;}}.card--one{flex:0 0 160px;margin-right:1.5em;}@media screen and (min-width:1280px){.simple--flex{& >:first-child{margin-left:0;}}.card--one{flex:0 0 180px;margin-right:1.5em;}}"]);
...
//# sourceMappingURL=[id].js.dfac572c0e9f6315c34d.hot-update.js.map
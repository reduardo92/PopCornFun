...
})(["padding:2em 0.5em;.head--container{display:flex;justify-content:space-between;align-items:center;}.tabs--container{display:flex;flex-wrap:wrap;}.tab{color:var(--white-clr);border-bottom:3px solid transparent;text-transform:capitalize;font-weight:600;}.activeTab{color:var(--primary-clr);border-bottom:3px solid var(--primary-clr);}"]);
...
//# sourceMappingURL=[id].js.e93e451234921a4c3fd6.hot-update.js.map
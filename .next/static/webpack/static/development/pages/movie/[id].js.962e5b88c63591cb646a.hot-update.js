...
var ProfileHeader = function ProfileHeader(_ref) {
  ...
  var getrating = function getrating() {
    var release_dates = data.release_dates.results.filter(function (item) {
      return item.iso_3166_1 === 'US';
    })[0].release_dates; //   const getratd = ratee.

    var getRate = release_dates.find(function (item) {
      return item.certification !== '' && item.certification;
    });
    return getRate;
  };
...
//# sourceMappingURL=[id].js.962e5b88c63591cb646a.hot-update.js.map
...
var MovieProfile = function MovieProfile(_ref2) {
  ...
  console.log(movie);
  console.log(_babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_8___default()(movie.keywords));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 2;
          _context.next = 5;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.awrap(Object(_components_utility_movieDB__WEBPACK_IMPORTED_MODULE_11__["default"])("movie/".concat(ctx.query.id || '454626'), 'append_to_response=account_states,external_ids,keywords,release_dates,videos,recommendations,reviews,credits,images&include_image_language=en,null'));
...
//# sourceMappingURL=[id].js.2cd049e0d06d1bf79a11.hot-update.js.map
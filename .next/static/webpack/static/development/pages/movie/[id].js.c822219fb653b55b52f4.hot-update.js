...
})(["padding:2em 0.5em;.head--container{display:flex;justify-content:space-between;align-items:center;}.tab{color:var(--white-clr);border-bottom:3px solid transparent;text-transform:capitalize;font-weight:bold;}.activeTab{color:var(--primary-clr);border-bottom:3px solid var(--primary-clr);}"]);
...
//# sourceMappingURL=[id].js.c822219fb653b55b52f4.hot-update.js.map
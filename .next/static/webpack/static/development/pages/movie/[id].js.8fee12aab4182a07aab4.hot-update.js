...
var MovieProfile = function MovieProfile(_ref2) {
  ...
  console.log('profile', movie); //   let countedNames = movie.credits.crew.reduce(function(acc, obj, index) {
  //     let key = obj.name;
  //     if (!acc[key]) {
  //       acc[key] = [];
  //     }
  ...
  //   console.log(
  //     'out',
  //     Object.entries(countedNames).map(([_, value]) =>
  //       value.map(item => item.department)
  //     )
  //     );

  var fdf = movie.credits.crew.reduce(function (accumulator, currentValue) {
    return [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(accumulator), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(currentValue.department));
  }, []);
  console.log(fdf);
  return __jsx(Styled, {
    className: "profile",
...
//# sourceMappingURL=[id].js.8fee12aab4182a07aab4.hot-update.js.map
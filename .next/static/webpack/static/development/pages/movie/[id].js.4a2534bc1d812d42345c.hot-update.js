...
})([".stat{text-transform:capitalize;margin-bottom:0.7em;}.stat--title{font-size:0.9rem;font-weight:bold;margin-bottom:0.1em;}.release--content{display:grid;grid-row-gap:1em;& >:first-child{margin-top:0.5em;}}.release--date{display:flex;align-items:center;justify-content:space-between;}.world{font-size:1.5rem;}"]);
...
//# sourceMappingURL=[id].js.4a2534bc1d812d42345c.hot-update.js.map
...
var MovieProfile = function MovieProfile(_ref2) {
  ...
  console.log('out', _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_2___default()(countedNames).map(function (_ref3, index) {
    var _ref4 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref3, 2),
        key = _ref4[0],
        value = _ref4[1];

    return {
      credit_id: value[0].credit_id,
      department: key[value].department.map(function (item) {
        return item;
      }),
      gender: value[0].credit_id,
      id: value[0].id,
      job: value[0].job,
      name: value[0].name
    };
...
//# sourceMappingURL=[id].js.3674008f31a2bcb4c338.hot-update.js.map
...
})(["padding:2em 0.5em;.head--container{display:flex;justify-content:space-between;align-items:center;}.tab{color:var(--white-clr);border-bottom:3px solid transparent;text-transform:capitalize;font-weight:600;}.activeTab{color:var(--primary-clr);border-bottom:3px solid var(--primary-clr);}"]);
...
//# sourceMappingURL=[id].js.04ccdad767be3f11cd71.hot-update.js.map
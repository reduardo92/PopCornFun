...
var MovieProfile = function MovieProfile(_ref2) {
  ...
  console.log('out', _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_1___default()(countedNames).map(function (item, index) {
    return {
      credit_id: item[0].credit_id,
      department: '',
      gender: item[0].credit_id,
      id: item[0].id,
      job: item[0].job,
      name: item[0].name
    };
...
//# sourceMappingURL=[id].js.f04a2c0c353a0e2602ac.hot-update.js.map
...
var ProfileHeader = function ProfileHeader(_ref) {
  ...
  var timeConvert = function timeConvert(time) {
    ...
    var minutes = Math.round((hours - rhours) * 60); // const rminutes = Math.round(minutes);

    console.log(hours, rhours, minutes, rminutes);
    return "".concat(rhours, "h ").concat(minutes, "m");
  };

  console.log(timeConvert(109));
  return __jsx(Styled, {
    ...
    __self: this
  }, __jsx(_CirclePercentage__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
//# sourceMappingURL=[id].js.bc566ace4b282f0e4065.hot-update.js.map
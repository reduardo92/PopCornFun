...
var MovieProfile = function MovieProfile(_ref2) {
  ...
  console.log('out', _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_2___default()(countedNames).map(function (item, index) {
    return Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, index, item);
  }));
  return __jsx(Styled, {
    className: "profile",
...
MovieProfile.getInitialProps = function _callee(_ref4) {
  var asPath, movie;
...
//# sourceMappingURL=[id].js.49e9fa307003507c715d.hot-update.js.map
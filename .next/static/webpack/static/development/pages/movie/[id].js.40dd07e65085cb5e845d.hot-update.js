...
var ProfileHeader = function ProfileHeader(_ref) {
  ...
  var getrating = function getrating() {
    var getRate = data.release_dates.results.filter(function (item) {
      return item.iso_3166_1 === 'US';
    })[0].release_dates.find(function (_ref2) {
      var certification = _ref2.certification;
      return certification !== '';
    }).certification; // const getRate = release_dates.find(item => item.certification !== '')
    //   .certification;
...
//# sourceMappingURL=[id].js.40dd07e65085cb5e845d.hot-update.js.map
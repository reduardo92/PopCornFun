...
})(["padding:1em;max-width:1000px;.subTitle{margin-bottom:1.5em;}.simple--flex{& >:first-child{margin-left:1em;}}.card--one{flex:0 0 160px;margin-right:1.5em;}@media screen and (min-width:1280px){.simple--flex{& >:first-child{margin-left:0;}}.card--one{flex:0 0 180px;margin-right:1.5em;}}"]);
...
//# sourceMappingURL=[id].js.39795a599d0c885dcbca.hot-update.js.map
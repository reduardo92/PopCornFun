...
})(["background:var(--bg-gradient);padding:5em 1em;.content--container{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));grid-auto-rows:auto;justify-items:center;}.card--title{grid-column:1 / 3;justify-self:start;margin:0 0 3em 1em;}.title{text-transform:capitalize;font-weight:bold;}.subtitle{color:var(--grey-clr);}@media screen and (min-width:768px){}"]);
...
//# sourceMappingURL=index.js.2c59b2b8cb0f13f84382.hot-update.js.map
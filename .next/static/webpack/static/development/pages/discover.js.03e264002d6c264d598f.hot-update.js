...
})([".discover--from{display:flex;flex-direction:column;}.clear--fields{background:var(--bg-gradient);font-size:1rem;padding:0.2em 0.87em;margin:1em auto;text-align:center;border-radius:3px;}@media screen and (min-width:768px){flex:100%;margin-bottom:1em;.discover--from{display:flex;flex-direction:row;justify-content:space-between;& > div{flex:1;margin-right:1em;}& >:last-child{margin-right:0;}.clear--fields{flex:0 0 30px;align-self:center;margin:0;margin-top:0.85em;font-size:1.3rem;}}}.genre--control .tv{display:", ";}@media screen and (min-width:1000px){flex:1;margin-left:2em;.discover--from{display:flex;justify-content:space-between;& > div{flex:1;margin-right:1em;}& >:last-child{margin-right:0;}}}"], function (_ref) {
...
//# sourceMappingURL=discover.js.03e264002d6c264d598f.hot-update.js.map
...
})(["background:var(--bg-dark-gradient);padding:150px 1em 5em 1em;.wrapper{max-width:1500px;margin:0 auto;.title{font-size:1.5rem;margin-bottom:1em;}}.content--container{display:grid;grid-gap:2em;margin:2em 0;}@media screen and (min-width:768px){.content--container{grid-row-gap:3.5em;grid-template-columns:repeat(2,1fr);}}"]);
...
var movie = function movie(_ref) {
  ...
  return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: this
  }, movies.title, " Movies"), __jsx(_components_ui_Pagination_Pagination__WEBPACK_IMPORTED_MODULE_8__["default"], {
    numberOfArticles: movies.total_pages,
    typeFor: "/movie?query=".concat(movies.title.split(' ').join('_'), "&page="),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 52
    },
...
//# sourceMappingURL=movie.js.26940c5c4519050ce9a0.hot-update.js.map
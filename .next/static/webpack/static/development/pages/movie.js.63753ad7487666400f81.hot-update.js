...
})(["display:flex;flex-direction:column;.card--poster{.card--poster--link img{transition:var(--ease--in--out--02s);height:100%;object-fit:cover;}&:hover .card--poster--link img{opacity:0.5;}}.card--body__overview,.more--info,.poster__img{display:none;}.card--body{background:var(--bg-gradient);border-radius:0 0 3px 3px;height:100%;&__head{display:flex;align-items:center;padding:0.5em 0;padding-left:0.5em;.CircularProgressbar{width:2.8em;flex:0 0 2.8em;margin-right:1em;}}}.title--section{.title{font-size:1.1rem;color:var(--white-clr);&:hover{opacity:0.8;}}.release--date{color:rgba(255,255,255,0.68);}}@media screen and (min-width:768px){}@media screen and (min-width:1000px){.card--body__overview,.more--info{display:block;}.backdrop__img{display:none;}.poster__img{display:block;}}"]);
...
//# sourceMappingURL=movie.js.63753ad7487666400f81.hot-update.js.map
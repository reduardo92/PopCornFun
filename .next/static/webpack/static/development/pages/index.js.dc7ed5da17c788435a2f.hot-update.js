...
/* harmony import */ var _TagGroup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../TagGroup */ "./components/ui/TagGroup.jsx");
...
var FeturedSection = function FeturedSection(_ref2) {
  ...
  return __jsx(Styled, {
    ...
    __self: this
  }), __jsx(_TagGroup__WEBPACK_IMPORTED_MODULE_8__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 222
    },
...
})(["display:flex;justify-content:space-between;width:200px;.tag{border:2px solid var(--white-clr);box-sizing:border-box;background:rgba(0,0,0,0.2);color:#000;border-radius:50%;width:35px;height:35px;padding:6px;color:var(--white-clr);transition:var(--ease--in--out--02s);&:hover,&:focus{color:var(--second-clr);background-color:var(--white-clr);}}"]);
...
//# sourceMappingURL=index.js.dc7ed5da17c788435a2f.hot-update.js.map
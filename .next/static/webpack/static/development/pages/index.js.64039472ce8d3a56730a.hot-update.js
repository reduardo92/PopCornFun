...
})(["background:var(--bg-gradient);padding:4em 1em;.content--container{display:grid;grid-template-columns:repeat(2,1fr);grid-auto-rows:auto;justify-items:center;}.card--title{grid-column:1 / 3;justify-self:center;margin-bottom:3em;}.title{text-transform:capitalize;font-weight:bold;}.subtitle{color:var(--grey-clr);}@media screen and (min-width:768px){.content--container{display:grid;grid-template-columns:repeat(3,1fr);grid-auto-rows:auto;justify-items:center;}.card--title{grid-column:1 / 4;}}@media screen and (min-width:1024px){.content--container{grid-template-columns:repeat(auto-fit,minmax(200px,1fr));}}"]);
...
//# sourceMappingURL=index.js.64039472ce8d3a56730a.hot-update.js.map
...
})(["max-width:350px;.title{font-size:1.1rem;}.card--body__overview,.more--info,.poster__img{display:none;}@media screen and (min-width:768px){.card--body__overview,.more--info{display:block;}}@media screen and (min-width:1000px){.backdrop__img{display:none;}.poster__img{display:block;}}"]);
...
//# sourceMappingURL=movie.js.6c3d442937a8eb873cfa.hot-update.js.map
...
})(["grid-column:", ";text-align:center;width:100%;position:relative;padding-top:2em;&::before{content:'';position:absolute;top:0;left:0;right:0;width:100px;margin:0 auto;border-top:1px solid rgba(255,255,255,0.6);}.title{text-transform:capitalize;font-weight:bold;}.subtitle{color:var(--grey-clr);}.button--simple{display:block;border-top:1px solid rgba(255,255,255,0.6);padding-top:2em;}@media screen and (min-width:768px){text-align:left;}"], function (_ref) {
...
//# sourceMappingURL=index.js.02a501167a0b93281293.hot-update.js.map
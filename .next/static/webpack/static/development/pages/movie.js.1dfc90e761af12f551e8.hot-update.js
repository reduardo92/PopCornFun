...
})([".title{font-size:1.1rem;}.card--body__overview,.more--info,.poster__img{display:none;}.card--body{background:var(--bg-gradient);background:var(--white-clr);color:black;&__head{display:flex;align-items:center;padding-left:0.5em;.CircularProgressbar{width:2.8em;flex:0 0 2.8em;margin-right:1em;}}}@media screen and (min-width:768px){.card--body__overview,.more--info{display:block;}}@media screen and (min-width:1000px){.backdrop__img{display:none;}.poster__img{display:block;}}"]);
...
//# sourceMappingURL=movie.js.1dfc90e761af12f551e8.hot-update.js.map
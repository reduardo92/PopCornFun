...
var FeturedSection = function FeturedSection(_ref2) {
  ...
  return __jsx(Styled, {
    ...
    toLink: "/".concat(typeFor, "/[id]"),
    asLink: "/".concat(typeFor, "/").concat(data.id),
    title: "view more",
    bgclr: true,
    __source: {
      fileName: _jsxFileName,
    ...
    onclick: function onclick() {
      return setModal(data.videos.key, 'videos');
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 123
...
//# sourceMappingURL=index.js.f42bd7d98296a587a383.hot-update.js.map
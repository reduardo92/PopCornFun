...
var DiscoverForm = function DiscoverForm(_ref2) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (year === '' && sort_by === 'popularity.desc' && genre === '') {
      push("/discover?query=".concat(typeFor).concat(sortQuery).concat(yearQuery).concat(genreQuery, "&page=1"));
      return;
    } else {
      if (genre === '') {
...
//# sourceMappingURL=discover.js.1d9452063f52f4441c47.hot-update.js.map
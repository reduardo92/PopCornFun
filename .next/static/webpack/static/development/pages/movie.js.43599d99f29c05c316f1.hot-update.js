...
})(["display:flex;flex-direction:column;.card--body__overview,.more--info,.poster__img{display:none;}.card--poster{.card--poster--link img{transition:var(--ease--in--out--02s);height:100%;object-fit:cover;}.backdrop__img{max-height:197.82px;}&:hover .card--poster--link img{opacity:0.5;}}.card--body{background:var(--bg-gradient);border-radius:0 0 3px 3px;height:100%;&__head{display:flex;align-items:center;padding:0.5em 0;padding-left:0.5em;height:inherit;.CircularProgressbar{width:2.8em;flex:0 0 2.8em;margin-right:1em;}}&__overview{font-size:0.9rem;}}.title--section{.title{font-size:1.1rem;color:var(--white-clr);&:hover{opacity:0.8;}}.release--date{color:rgba(255,255,255,0.68);}}.more--info{border-top:1px solid var(--second-clr);}@media screen and (min-width:1000px){flex-direction:row;.card--body__overview,.more--info,.poster__img{display:block;}.backdrop__img{display:none;}.card--poster{flex:0 0 34%;width:34%;}.card--body{height:auto;display:flex;flex-direction:column;justify-content:space-around;&__head{padding:0.5em;height:auto;.CircularProgressbar{}}}}"]);
...
//# sourceMappingURL=movie.js.43599d99f29c05c316f1.hot-update.js.map
...
})(["background:var(--bg-gradient);padding:4em 1em;.content--container{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));grid-auto-rows:auto;justify-items:center;}.card--title{grid-column:1 / 3;justify-self:center;margin-bottom:3em;}.title{text-transform:capitalize;font-weight:bold;}.subtitle{color:var(--grey-clr);}@media screen and (min-width:1024px){.content--container{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));grid-auto-rows:auto;justify-items:center;}.card--title{grid-column:1 / 5;}}"]);
...
//# sourceMappingURL=index.js.e16d22629ede8cdef7a6.hot-update.js.map
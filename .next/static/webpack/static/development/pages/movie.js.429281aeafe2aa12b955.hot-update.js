...
})(["max-width:300px;.title{font-size:1.1rem;}.card--body__overview,.more--info,.poster__img{display:none;}@media screen and (min-width:768px){.card--body__overview,.more--info{display:block;}}@media screen and (min-width:1000px){.backdrop__img{display:none;}.poster__img{display:block;}}"]);
...
//# sourceMappingURL=movie.js.429281aeafe2aa12b955.hot-update.js.map
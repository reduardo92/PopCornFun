...
})(["position:relative;min-height:85vh;background:linear-gradient(rgba(0,0,0,0.55),rgba(0,0,0,0.55)),url(", ") no-repeat center;background-size:cover;object-fit:cover;width:100%;display:flex;align-items:center;justify-content:center;.max-width{padding:0 1em;}.heading{display:flex;}@media screen and (min-width:768px){min-height:50vh;}"], function (_ref) {
...
//# sourceMappingURL=index.js.b6f8417c97bffdb954f2.hot-update.js.map
...
})([".title{font-size:1.1rem;}.card--body__overview,.more--info,.poster__img{display:none;}.card--body{&__head{display:flex;align-items:center;.CircularProgressbar{width:2.8em;flex:0 0 2.8em;margin-right:1em;}}}@media screen and (min-width:768px){.card--body__overview,.more--info{display:block;}}@media screen and (min-width:1000px){.backdrop__img{display:none;}.poster__img{display:block;}}"]);
...
//# sourceMappingURL=movie.js.9289c5db10453ba0c945.hot-update.js.map
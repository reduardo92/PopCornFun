...
})(["position:relative;min-height:85vh;background:linear-gradient(rgba(0,0,0,0.55),rgba(0,0,0,0.55)),url(", ") no-repeat center;background-size:cover;object-fit:cover;width:100%;display:flex;align-items:center;justify-content:center;.max-width{padding:0 1em;display:grid;}.fetured--content{width:100%;max-width:480px;display:grid;grid-gap:1em;text-align:left;justify-items:left;}.button{border-radius:5px;}.fetured--action{margin-top:1em;button{background:transparent;border:none;color:var(--white-clr);font-weight:bold;margin-top:0.5em;transition:var(--ease--in--out--02s);}svg{margin-left:5px;font-size:2rem;color:var(--primary-clr);transition:var(--ease--in--out--02s);}&:hover button,&:focus button{color:var(--primary-clr);}&:hover svg,&:focus svg{color:var(--white-clr);}}.heading{display:flex;width:100%;align-items:flex-end;}.title{margin-bottom:0;margin-right:0.5em;}@media screen and (min-width:768px){min-height:50vh;.max-width{grid-template-columns:1fr 1fr;justify-items:center;align-items:center;width:100%;}.fetured--action{display:flex;flex-direction:column;svg{font-size:8rem;order:-1;color:var(--primary-clr);}}}@media screen and (min-width:1200px){min-height:80vh;}"], function (_ref) {
...
//# sourceMappingURL=index.js.97f85be0f06dbe0bd382.hot-update.js.map
...
})(["margin-bottom:2em;.card--poster{&:hover .card--poster--link img{background-color:red;}}.card--body__overview,.more--info,.poster__img{display:none;}.card--body{background:var(--bg-gradient);border-radius:0 0 3px 3px;&__head{display:flex;align-items:center;padding-left:0.5em;.CircularProgressbar{width:2.8em;flex:0 0 2.8em;margin-right:1em;}}}.title--section{.title{font-size:1.1rem;}.release--date{color:rgba(255,255,255,0.68);}}@media screen and (min-width:768px){.card--body__overview,.more--info{display:block;}}@media screen and (min-width:1000px){.backdrop__img{display:none;}.poster__img{display:block;}}"]);
...
//# sourceMappingURL=movie.js.b0556c86a816eda81254.hot-update.js.map
...
})(["margin-top:auto;display:grid;position:relative;text-align:center;background:url('/ticketBg.jpg') center;z-index:1;&::before{content:'';position:absolute;top:0;right:0;bottom:0;left:0;background-image:linear-gradient( to top,#1c0c07,#1e0d07,#200e08,#210e08,#230f08 );z-index:-1;opacity:0.96;}p{color:var(--white-clr);}.content{padding:2em 0;max-width:1400px;margin:0 auto;}.logo{display:block;margin-bottom:2em;font-weight:bold;img{width:80px;margin:0 auto;}}.join--btn{background-color:var(--white-clr);color:var(--primary-clr-rgba);font-size:1.3em;font-weight:bold;display:block;word-wrap:break-word;white-space:normal;text-transform:uppercase;border-radius:5px;padding:8px 16px;}.footer--nav{display:flex;justify-content:space-between;margin-top:2em;&__link{border-bottom:1px solid transparent;}.selected{border-bottom-color:var(--primary-clr) !important;color:var(--white-clr) !important;}}.copyRight{padding:1em 0;align-self:end;}"]);
...
//# sourceMappingURL=_app.js.68f45fdb01cee543570b.hot-update.js.map
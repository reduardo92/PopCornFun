...
})([".clear--fields{background:var(--bg-gradient);width:fit-content;font-size:1.2rem;font-weight:bold;padding:0.4em 0.8em;margin:0 auto;border-radius:3px;}@media screen and (min-width:768px){flex:100%;margin-bottom:1em;.discover--from{display:flex;justify-content:space-between;& > div{flex:1;margin-right:1em;}& >:last-child{margin-right:0;}}}.genre--control .tv{display:", ";}@media screen and (min-width:1000px){flex:1;margin-left:2em;.discover--from{display:flex;justify-content:space-between;& > div{flex:1;margin-right:1em;}& >:last-child{margin-right:0;}}}"], function (_ref) {
...
//# sourceMappingURL=discover.js.ba7a9dd25f26e2cfe38a.hot-update.js.map
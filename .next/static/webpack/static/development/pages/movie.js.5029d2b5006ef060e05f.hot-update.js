...
var Pagination = function Pagination(_ref) {
  ...
  return __jsx(Styled, {
    ...
    className: "controls ".concat(pagination[0] === currentPage && 'disabled d-none'),
    ...
    className: "controls ".concat(pagination.reverse()[0] === currentPage && 'disabled d-none'),
    onClick: function onClick() {
      return paginate(currentPage + 1);
    },
    __source: {
    ...
    className: "controls ".concat(numberOfArticles === currentPage && 'disabled d-none'),
    onClick: function onClick() {
...
//# sourceMappingURL=movie.js.5029d2b5006ef060e05f.hot-update.js.map
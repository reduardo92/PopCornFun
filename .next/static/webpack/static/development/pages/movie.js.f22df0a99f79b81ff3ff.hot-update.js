...
})(["width:calc(100vw - 20px);.title{font-size:1.1rem;}.card--body__overview,.more--info,.poster__img{display:none;}@media screen and (min-width:768px){.card--body__overview,.more--info{display:block;}}@media screen and (min-width:1000px){.backdrop__img{display:none;}}"]);
...
//# sourceMappingURL=movie.js.f22df0a99f79b81ff3ff.hot-update.js.map
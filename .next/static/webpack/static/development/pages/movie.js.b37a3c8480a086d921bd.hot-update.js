...
})(["background:var(--bg-dark-gradient);padding:150px 1em 0 1em;.wrapper{max-width:1500px;margin:0 auto;.title{font-size:1.5rem;margin-bottom:1em;}}.content--container{display:grid;grid-gap:3em;}@media screen and (min-width:768px){.content--container{grid-gap:2em;grid-template-columns:repeat(2,1fr);}}"]);
...
//# sourceMappingURL=movie.js.b37a3c8480a086d921bd.hot-update.js.map
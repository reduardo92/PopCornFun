...
var DiscoverForm = function DiscoverForm() {
  ...
  var yearQuery = "&year=".concat(year);
  var genreQuery = genre === '' ? '' : "&genres=".concat(genre);
  var router = Object(next_router__WEBPACK_IMPORTED_MODULE_1__["useRouter"])();
  console.log(router);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (year === '' && sort_by === 'popularity.desc' && genre === '') {
      push("/discover?query=".concat(router.query.query).concat(sortQuery).concat(yearQuery).concat(genreQuery, "&page=").concat(query.page));
      return;
    } else {
...
//# sourceMappingURL=discover.js.20236abd9f0e1d2c6e41.hot-update.js.map
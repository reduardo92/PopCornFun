...
var DiscoverForm = function DiscoverForm(_ref2) {
  ...
  return __jsx(Styled, {
    ...
    onClick: function onClick() {
      return push("/discover?query=".concat(query.query).concat(sortQuery).concat(genreQuery, "&page=1"));
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 191
...
//# sourceMappingURL=discover.js.06d1c80eafe2067363e1.hot-update.js.map
...
})(["width:160px;.card--poster{position:relative;transition:var(--ease--in--out--02s);cursor:pointer;background-color:var(--second-clr);height:240px;border-radius:10px;img{height:100%;object-fit:contain;border-radius:10px;}&::after{content:'View More';transition:var(--ease--in--out--02s);display:flex;justify-content:center;align-items:center;position:absolute;font-size:0.8rem;font-weight:bold;background-color:var(--primary-clr-rgba);height:0;width:100%;opacity:0;top:0;left:0;right:0;}&:hover::after,&:focus::after{opacity:1;height:100%;}}.card--body{position:relative;display:grid;.CircularProgressbar{width:40px;margin-top:-1.65em;margin-left:0.5em;justify-self:auto;}&__info{color:", ";display:flex;align-items:baseline;.info--top{font-size:0.9rem;}}&__title a{font-weight:bold;color:", ";transition:var(--ease--in--out--02s);&:hover,&:focus{color:var(--primary-clr);}}}@media screen and (min-width:1280px){width:180px;.card--poster{height:270px;}}"], function (_ref) {
...
//# sourceMappingURL=index.js.6281456c7c3ea4f816ec.hot-update.js.map
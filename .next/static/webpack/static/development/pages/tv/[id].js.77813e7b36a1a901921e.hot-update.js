...
var Facts = function Facts(_ref) {
  ...
  var releaseData = data[typeFor === 'tv' ? 'content_ratings' : 'release_dates'].results.filter(function (item) {
    return item.iso_3166_1 === 'US';
  })[0];
  console.log('hello', releaseData);
  return __jsx(Styled, {
...
//# sourceMappingURL=[id].js.77813e7b36a1a901921e.hot-update.js.map
...
var ProfileHeader = function ProfileHeader(_ref) {
  ...
  return __jsx(Styled, {
    ...
    __self: this
  }, data.credits.crew.length === 0 ? data.created_by.map(function (item) {
    ...
    return i < 6 && __jsx(_CrewTab__WEBPACK_IMPORTED_MODULE_11__["default"], {
      key: item.id,
      crew: item,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=[id].js.d07755495c5b24afac65.hot-update.js.map
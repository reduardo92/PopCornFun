...
})(["background-color:#e2e2e2;*{color:var(--second-clr);}.inner--content{display:grid;grid-row-gap:1em;padding:2em 0em;}.title{font-size:1.2rem;margin-bottom:1em;}@media screen and (min-width:1000px){width:calc((100vw - 1000px) / 2 + 220px);min-height:calc(100vh - 795px);.inner--content{padding:2em;}}"]);
...
//# sourceMappingURL=[id].js.f2ab52d1398ad15c7433.hot-update.js.map
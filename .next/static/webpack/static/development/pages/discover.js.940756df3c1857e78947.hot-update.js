    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          sort_by = "sort_by=".concat(query.sort_by ? query.sort_by : 'popularity.desc'); // const year = `&primary_release_year=${query.year ? query.year : ''}`;

          year = query.year ? "&".concat(query.query === 'movie' ? 'primary_release_year' : 'first_air_date_year', "=").concat(query.year) : '';
          genres = query.genres ? "&with_genres=".concat(query.genres) : ''; // const genres = `&with_genres=${query.genres ? query.genres : ''}`;
...
//# sourceMappingURL=discover.js.940756df3c1857e78947.hot-update.js.map
...
/* harmony import */ var _server_models_Favorite__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../server/models/Favorite */ "./server/models/Favorite.js");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_server_middleware_auth__WEBPACK_IMPORTED_MODULE_0__["default"])(async (req, res) => {
  ...
  switch (method) {
    ...
    case 'GET':
      try {
        const favorite = await _server_models_Favorite__WEBPACK_IMPORTED_MODULE_3__["default"].find({
          user: req.user.id
        }).sort({
          date: -1
        });
    ...
    case 'POST':
      ...
      try {
        let checkMedia = await _server_models_Favorite__WEBPACK_IMPORTED_MODULE_3__["default"].findOne({
          media_id
        });
        ...
        const newFavorite = new _server_models_Favorite__WEBPACK_IMPORTED_MODULE_3__["default"]({
          media,
          user: req.user.id
        });
    ...
    case 'DELETE':
      ...
      // @access  Private
      try {
        let favorite = await _server_models_Favorite__WEBPACK_IMPORTED_MODULE_3__["default"].findById(req.query.id);
        ...
        await _server_models_Favorite__WEBPACK_IMPORTED_MODULE_3__["default"].findByIdAndRemove(req.query.id);
        res.json({
...
const FavoriteSchema = new mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema({
  user: {
...
const Favorite = mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.models.Favorite || mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.model('Favorite', FavoriteSchema);
...
/***/ 10:
/*!**************************************!*\
  !*** multi ./pages/api/favorites.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\Eduardo Rivas\Desktop\react_Study\popcornFun\pages\api\favorites.js */"./pages/api/favorites.js");
